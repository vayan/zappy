...
// ------------------ Lapin Mania ----------------//
  ...
  // fctTable[1] = &Player::IfFoodSup10;
  // fctTable[2] = &Player::SearchNourriture;
  // fctTable[3] = &Player::Avance;
  // fctTable[4] = &Player::GoToDir;
  // fctTable[5] = &Player::RamassezNourriture;
  // fctTable[6] = &Player::AssezRessourceForLevel;
  // fctTable[7] = &Player::SearchRessourceForLvl;
  // fctTable[8] = &Player::RamassezRessourceForLvl;
  // fctTable[9] = &Player::VideCase;
  // fctTable[10] = &Player::IfFoodSup10;
  // fctTable[11] = &Player::PoserRessourceForLvl;
